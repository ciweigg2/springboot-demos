package com.example.springbootestransport.controller;

import cn.hutool.core.date.DateUtil;
import com.alibaba.fastjson.JSONObject;
import com.example.springbootestransport.model.Employee;
import com.example.springbootestransport.util.ElasticsearchUtils;
import com.example.springbootestransport.util.EsPage;
...
public class EsController {
    ...
    public String insertJson() {
        ...
        jsonObject.put("last_name", "eaffsade");
    ...
    public String queryMatchData() {
        ...
        List<Map<String, Object>> list = ElasticsearchUtils.
